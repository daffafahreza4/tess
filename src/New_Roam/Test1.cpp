...
class ListFungsi // deklarasikan class yang menampung kumpulan fungsi-fungsi
{
public: // semua fungsi dimasukan ke dalam public
...
} x; // deklarasikan nama variabel classnya;
...
start:                     // deklarasikan checkpoint untuk kembali ke menu utama
    ...
    case '1': // jika user menginputkan '1'
        ...
        cin >> CCmobil;
        x.insert(pabrikan, namaMobil, tahunProduksi, CCmobil);
    ...
    case '2':            // jika user menginputkan '2'
        ...
        x.print();
        x.insertMid(pabrikan, namaMobil, tahunProduksi, CCmobil);
