...
tujuan:
    cout << "Rincian harga destinasi setiap tempat : \n";
    cout << "Sabang = Rp1.000.000\n";
    cout << "Jakarta = Rp450.000\n";
    cout << "Jogja = Rp700.000\n";
    cout << "Bali = Rp4.000.000\n";
    cout << "Raja Ampat = Rp1.000.000\n";
    ...
    cout << "Berapa jumlah tiket yang anda inginkan : ";
        ...
        pembeli data[jumlah];
            for(int i=0; i<jumlah; i++){
                ...
                cout << "Masukkna Tanggal Lahir penumpang " << i+1 << " : ";
...
cout << "------------------------------------" << endl;
    ...
    cin >> pilihanY;    
        if(pilihanY=='y'){
            cout << "Total biaya anda: " << total;
        }else{
            cout << "Pilih data yang salah: ";
            cin >> pilihan;
                switch (pilihan){
                case 1:
                    goto tujuan;
